...
?>
<nav class="font-[poppins] hidden md:block sticky top-0 bg-white shadow-md z-50">
    <div class="container mx-auto px-6 py-3 flex items-center justify-between">
        <!-- Logo -->
        <div class="font-[fredoka] flex items-center group">
        ...
        <div class="hidden md:flex space-x-8 text-md">
            ...
            <!-- Tes Kecerdasan -->
            <a href="<?php echo $currentPage == 'intelligenceTest.php' ? '#test' : 'intelligenceTest.php#test'; ?>"
                class="text-gray-700 hover:text-primary-500 font-semibold transition-colors duration-300 relative after:absolute after:bottom-0 after:left-0 after:bg-primary-500 after:h-0.5 after:w-0 hover:after:w-full after:transition-all after:duration-300">
                Tes Kecerdasan
            </a>
        </div>
        ...
        <div class="flex space-x-3">
            <!-- Tombol Masuk -->
            <a href="login.php"><button class="bg-secondary-500 hover:bg-secondary-600 text-white text-md font-semibold py-2.5 px-5 rounded-full transition-all duration-300 transform hover:scale-105 hover:shadow-lg">
                    Masuk
                </button></a>
            <!-- Tombol Daftar -->
            <a href="register.php"><button class="bg-primary-500 hover:bg-primary-600 text-white text-md font-semibold py-2.5 px-5 rounded-full transition-all duration-300 transform hover:scale-105 hover:shadow-lg">
                    Daftar
                </button></a>
        </div>
    </div>
