                    ...
                    <div class="w-full lg:w-6/12 px-4">
                      <div class="relative w-full mb-3">
                        ...
                        <div class="flex items-center border rounded shadow bg-white px-3">
                          ...
                          <input name="nama_guru" type="text" required value="<?= htmlspecialchars($pengguna['nama_guru']) ?>" class="border-0 py-3 placeholder-gray-300 text-gray-600 bg-white text-sm w-full focus:outline-none" />
                        </div>
                      </div>
                    </div>
                    <div class="w-full lg:w-6/12 px-4">
              ...
              <div class="px-6 -mt-16">
                ...
                <div class="text-center mt-6">
                  <h3 class="text-xl font-semibold text-gray-800">
                    <i class="fas fa-user mr-2 text-primary-500"></i><?= htmlspecialchars($pengguna['nama_guru']) ?>
                  </h3>
                  <div class="mt-2">
                    <span class="inline-flex items-center px-3 py-1 text-xs font-semibold bg-primary-100 text-primary-700 rounded-full uppercase tracking-wide">
                      <i class="fas fa-user-shield mr-1"></i> <?= htmlspecialchars($pengguna['jabatan']) ?>
                    </span>
                  </div>
                </div>
